...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container">
    ...
    <router-link class="navbar-brand" to="/">
      <i class="fab fa-shopware"></i> Rocks.se
    </router-link>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown me-4">
          ...
          >
            ...
            <span class="badge rounded-pill badge-notification bg-danger">{{shoppingCartItemCount}}</span>
          </a>
...
export default {
  ...
  computed: {
    ...mapGetters(['loggedIn', 'shoppingCartItemCount'])
  },
  methods: {
    ...mapActions(['logout'])
  }
